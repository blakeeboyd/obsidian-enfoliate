...
| Click action | Jump to term in the document | What a click on a sidebar item does: jump, or open in current tab / new tab / split / new window |
...
| Shift+click action | Open in a new window | Same choices, for Shift+click |
